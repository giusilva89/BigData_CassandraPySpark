...
return Row(date = (fields[0]),tweet_id = int(fields[1]),text = (fields[2]),
           reply_count = int(fields[3]),retweet_count = int(fields[4]),like_count = int(fields[5]),quote_count = int(fields[6]))
